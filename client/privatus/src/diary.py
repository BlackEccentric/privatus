...
dir_path = commons.move_back(os.path.dirname(realpath))
...
class diaryLogin(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.resize(311, 176)
        self.setMinimumSize(QtCore.QSize(311, 176))
        self.setMaximumSize(QtCore.QSize(311, 176))
        self.centralwidget = QtWidgets.QWidget(self)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(30, 40, 241, 16))
        self.label.setObjectName("label")
        self.label.setText("Please enter your diary's passphrase")
        self.passwordEdit = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.passwordEdit.setGeometry(QtCore.QRect(30, 60, 241, 31))
        font = QtGui.QFont()
        ...
        self.loginButton.setGeometry(QtCore.QRect(110, 110, 75, 31))
        ...
        self.icon.addPixmap(QtGui.QPixmap(dir_path + "/cowicon.png"), QtGui.QIcon.Selected, QtGui.QIcon.On)
...
class Main(QtWidgets.QMainWindow):
    ...
    def decryptEntries(self, entries):
        index = 0
        if entries == None or entries == "Server side error":
            QtWidgets.QMessageBox.warning(self, "Server side error!", "The server returned none or 'Server side error'!", QtWidgets.QMessageBox.Ok)
