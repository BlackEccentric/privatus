...
class App(QtWidgets.QSystemTrayIcon):
    ...
    def diaryFunc(self):
        if self.diaryWindow == None and self.connection.isConnected:
            self.diaryWindow = diary.Main(self.connection)
    ...
    def showEntry(self, id):
        self.diaryWindow.show_entry(self.connection.connection.sendInput("showEntry", {'id': id}))
