...
class Server:
    ...
    def client_thread(self, client):
                ...
                try:
                    ...
                    if message != None:
                        ...
                        try:
                            ...
                            send_msg(client, "Server side error", self.aes_key)
        ...
        elif self.database.check_if_column_equal("users", 0, username) and self.database.check_row_column(self.database.get_user("users", username), 1, password) and commons.check_dict(self.onlineUsers, username, True):
